...
/* Insertar iconos a elementos html */
document.getElementById("PiedraInicio").innerHTML = iconoPiedra;
document.getElementById("PapelInicio").innerHTML = iconoPapel;
document.getElementById("TijerasInicio").innerHTML = iconoTijeras;

document.getElementById("PiedraJugada").innerHTML = iconoPiedra;
document.getElementById("PapelJugada").innerHTML = iconoPapel;
document.getElementById("TijerasJugada").innerHTML = iconoTijeras;


/* Al apretar "Entrar", reproducir música, ocultar sección inicio y mostrar secciones Título y Cantidad */
...
/* Setea la cantidad de jugadas y valida si se ha ingresado un número */
function ronda() {

    /* Asignación de variables */
    cantidad = parseInt(document.getElementById('Cant').value);
    jugadasTotales = cantidad;

    /* Si la cantidad es mayor a 0 o si es válida */
    if (cantidad > 0 || cantidad) {

        /* Insertar datos en elemntos html */
        document.getElementById("Ronda").innerHTML = cont;
        document.getElementById("Robot").innerHTML = "= " + puntosCom;
        document.getElementById("Jugador").innerHTML = puntosJug + " =";
        document.getElementById("Creditos").innerHTML = cantidad;
        document.getElementById("txtCreditos").innerHTML = 'Partidas restantes:';

        /* Al apretar "Jugar", ocultar sección Cantidad y mostrar sección Jugada */
        $("#Cantidad").toggle('slow');
        $("#Jugada").css("display", "block");
    }
}


/* Realiza una jugada por opción escogida */
function jugada() {

    /* Obtiene la opción seleccionada por el jugador */
    var opcionJug = $('input[name="opcionSeleccionada"]:checked').val();


    /* Valida que se haya ingresado una opción */
    if (opcionJug) {

        /* Mientras la cantidad de jugadas sea mayor a 0 */
        while (cantidad > 0) {

            /* Opción random del computador */
            var opcionCom = Math.floor(Math.random() * 3);

            /* Contador inicial de la ronda aumenta en 1 */
            cont++;

            /* Inserta el numero de rondas al elemento html */
            document.getElementById("Ronda").innerHTML = cont;
        ...
        /* Resta 1 a la canatidad de jugadas */
        cantidad--;

        /* Inserta la cantidad de jugadas restantes al elemento html */
        document.getElementById("Creditos").innerHTML = cantidad;


        /* Si la opcion del computador es 0 */
        if (opcionCom == 0) {

            /* Inserta el ícono al elemento html de acuerdo a la opción seleccionada */
            document.getElementById("opcionCom").innerHTML = iconoPiedra;

            /* Si la opcion del computador es 1 */
        } else if (opcionCom == 1) {

            /* Inserta el ícono al elemento html de acuerdo a la opción seleccionada */
            document.getElementById("opcionCom").innerHTML = iconoPapel;

            /* Si la opcion del computador es 2 */
        } else if (opcionCom == 2) {

            /* Inserta el ícono al elemento html de acuerdo a la opción seleccionada */
            document.getElementById("opcionCom").innerHTML = iconoTijeras;
        }

        /* Si la opcion del jugador es 0 */
        if (opcionJug == 0) {

            /* Inserta el ícono al elemento html de acuerdo a la opción seleccionada */
            document.getElementById("opcionJug").innerHTML = iconoPiedra;

            /* Si la opcion del jugador es 1 */
        } else if (opcionJug == 1) {

            /* Inserta el ícono al elemento html de acuerdo a la opción seleccionada */
            document.getElementById("opcionJug").innerHTML = iconoPapel;

            /* Si la opcion del jugador es 2 */
        } else if (opcionJug == 2) {

            /* Inserta el ícono al elemento html de acuerdo a la opción seleccionada */
            document.getElementById("opcionJug").innerHTML = iconoTijeras;
        }


        /* Si la opción del computador y del jugador son iguales */
        if (opcionCom == opcionJug) {

            /* Agregar un punto al computador y un punto al jugador */
            puntosCom++;
            puntosJug++;

            /* Inserta los puntajes y el mensaje a los elementos html */
            document.getElementById("Robot").innerHTML = "= " + puntosCom;
            document.getElementById("Jugador").innerHTML = puntosJug + " =";
            ...
            /* Si la opción del computador es 0 y la opción del jugador es 1 */
            if (opcionCom == 0 && opcionJug == 1) {

                /* Agregar un punto al jugador */
                puntosJug++;

                /* Inserta el puntaje y el mensaje a los elementos html */
                document.getElementById("Jugador").innerHTML = puntosJug + " =";
                document.getElementById("Mensaje").innerHTML = "Ganaste!";
            }

            /* Si la opción del computador es 0 y la opción del jugador es 2 */
            if (opcionCom == 0 && opcionJug == 2) {

                /* Agregar un punto al computador */
                puntosCom++;
            ...
            /* Si la opción del computador es 1 y la opción del jugador es 0 */
            if (opcionCom == 1 && opcionJug == 0) {
            ...
            /* Si la opción del computador es 1 y la opción del jugador es 2 */
            if (opcionCom == 1 && opcionJug == 2) {
            ...
            /* Si la opción del computador es 2 y la opción del jugador es 0 */
            if (opcionCom == 2 && opcionJug == 0) {
        ...
        /* Si el contador es igual a las jugadas totales */
        if (cont === jugadasTotales) {

            /* Inserta palabra "final" a la ronda final */
            document.getElementById("Ronda").innerHTML = "final";
        }


        /* Si la cantidad restante es 0 */
        if (cantidad === 0) {

            /* Ocultar sección Jugada y mostrar sección ResultParcial */
            $("#Jugada").toggle('fast');
            $("#ResultParcial").toggle('fast');

            /* Insertar los puntos de cada jugador a los elementos html */
            document.getElementById("RobotFinal").innerHTML = "= " + puntosCom;
            document.getElementById("JugadorFinal").innerHTML = puntosJug + " =";

            /* Si el puntaje total del jugador es mayor al del computador */
            if (puntosJug > puntosCom) {
                ...
                /* Si el puntaje total del jugador es menor al del computador */
            } else if (puntosJug < puntosCom) {
                ...
                /* El puntaje total del jugador es igual al del computador */
            } else {
            ...
            /* Eliminar contenido visible de los elementos html */
            document.getElementById("Creditos").innerHTML = '';
            document.getElementById("txtCreditos").innerHTML = '';

            /* Setea el tiempo de visibilidad de sección ResultParcial
             y al terminar tiempo mostrar sección ResultFinal */
            setTimeout(function () {

                $("#ResultFinal").toggle('slow');
                $("#ResultParcial").toggle('slow');
            ...
            /* Setea el tiempo de visibilidad de la sección ResultParcial
              y al terminar mostrar sección jugada */
            setTimeout(function () {
...
/* Resetea las variables y elementos html a los valores iniciales */
function jugarDeNuevo() {
    ...
    /* Inserta datos por defecto a elementos html */
    document.getElementById("Cant").value = "";
    opcionJug = (document.querySelector('input[name="opcionSeleccionada"]:checked').checked = false);

    /* Oculta sección ResultFinal y muestra nuevamente sección Cantidad */
    $("#Cantidad").toggle('slow');
    $("#ResultFinal").toggle('slow');
}
